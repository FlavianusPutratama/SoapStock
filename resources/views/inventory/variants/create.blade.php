                ...
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <form method="POST" action="{{ route('inventory.variants.store', $product->id) }}"> {{-- Action ke store dengan product ID --}}
                        ...
                        <div>
                            ...
                            <input id="size" class="block mt-1 w-full rounded-md shadow-sm" type="text" name="size" value="{{ old('size') }}" required />
                        ...
                        <div class="mt-4">
                            ...
                            <input id="purchase_price" class="block mt-1 w-full rounded-md shadow-sm" type="number" name="purchase_price" value="{{ old('purchase_price') }}" min="0" step="50" required />
                        ...
                        <div class="mt-4">
                            ...
                            <input id="selling_price" class="block mt-1 w-full rounded-md shadow-sm" type="number" name="selling_price" value="{{ old('selling_price') }}" min="0" step="50" required />
