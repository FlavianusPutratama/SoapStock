                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @auth
                        @if(auth()->user()->role == 'superadmin')
                            ...
                            {{-- <x-nav-link :href="route('admin.revenue.report.detailed')" :active="request()->routeIs('admin.revenue.report.detailed')">
                                 {{ __('Laporan Detail') }}
                            </x-nav-link> --}}
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if(auth()->user()->role == 'superadmin')
                    ...
                    {{-- <x-responsive-nav-link :href="route('admin.revenue.report.detailed')" :active="request()->routeIs('admin.revenue.report.detailed')">
                         {{ __('Laporan Detail') }}
                    </x-responsive-nav-link> --}}
